...
# while IFS= read -r fastq; do sbatch --export=strain=$fastq Kraken2_WS.sh c_briggsae; done < /vast/eande106/projects/Lance/THESIS_WORK/pathogen_unalignedBAM_SDSU/raw_data/c_briggsae/unaligned_reads/wild_strains/need_to_process.txt
# while IFS= read -r fastq; do sbatch --export=strain=$fastq Kraken2_WS.sh c_elegans; done < /vast/eande106/projects/Lance/THESIS_WORK/pathogen_unalignedBAM_SDSU/raw_data/c_elegans/unaligned_reads/wild_strains/need_to_process.txt
